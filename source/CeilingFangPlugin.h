...
class CeilingFangPlugin final : public yup::AudioProcessor
{
public:
    CeilingFangPlugin();
...
private:
    enum ParameterIndex { ceiling, lookahead, release, detect, zeroBias, adapt, clip, parameterCount };
    ...
    ceilingfang::CeilingFangEngine engine;
...
#endif
    std::array<yup::String, 4> presetNames { "Fang Catch", "Glass Roof", "Zero Bite", "Clip Guard" };
};
